//This was javascript roughly thrown together for static presentation, 
//TODO refactor into smaller files during development. 
...
//starting to modulate code;
  ...
  if($("#addEvent_form").length != 0){
	...
	$("#edit_photo.edit_player_photo, #edit_photo.edit_event_photo").click(
	  function(e){
	    e.preventDefault();
	    $("#upload_photo_modal").modal().on('hidden', function() { $("#confirm_image").hide(); });
	    editProfilePhoto();
	  }
	);
  ...
  var mapOptions = {
   ...
   if(locationQuery){
    ...
    var marker = new google.maps.Marker({
                    icon: "assets/icon/ball_pointer.png",
